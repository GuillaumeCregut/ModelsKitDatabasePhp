...
{block name=title}Models Kit Database - Paramètres - Catégories{/block}
{block name=styles}
<link rel="stylesheet" href="assets/styles/params/category.css">
<link rel="stylesheet" href="assets/styles/params/single.css">
{/block}
{block name=script}
{if isset($connected) &&  isset(isAdmin)}
    <script src="assets/scripts/categories.js" defer></script>
...
<div class="params-container">
    <section class="list">
        <h2 class="categories_title">Gestion des catégories</h2>
        {if isset($list)}
            <div class="items-container">
                {if isset($connected) &&  isset(isAdmin)}
                    <form action="parametres_categories" method="post" id="form-delete-category">
                        ...
                        {foreach from=$list item=category}
                            <tr class="single-row">
                                <td class="single-cell">
                                    <span class="category-name" data-id="{$category->getId()}">
                                        {$category->getName()}
                                    </span>
                                </td>
                                <td class="single-cell">
    ...
    {if isset($connected) &&  isset(isAdmin)}
        <div class="singleModal modal-hidden">
            <section class="single-modal-container">
                <form action="parametres_categories" method="post" id="update_single">
